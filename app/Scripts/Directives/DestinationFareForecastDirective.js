angular.module('TrippismUIApp').directive('destinationFareForecast', ['$rootScope', '$compile', '$modal', 'DestinationFactory', 'FareforecastFactory', 'UtilFactory', '$stateParams', '$state',
    function ($rootScope, $compile, $modal, DestinationFactory, FareforecastFactory, UtilFactory, $stateParams, $state) {
        return {
            restrict: 'E',
            scope: {
                fareParams: '='
