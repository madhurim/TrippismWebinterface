    ...
    function EmailForDestinationDet($scope, $filter, $modal,
        ...
        function activate() {
            ...
            var contentString = '<div style="font-family: arial,sans-serif;color: black;">' +
                           '<p>Hey there!</p><p> Check this out... I found a cool vacation destination going from [ ' + eMailData.OriginairportName.airport_FullName + ' ]. Its [ ' + eMailData.DestinationairportName.airport_CityName + ' ] ! . What do you think ? Click here for More detail ' + tripissm_rdrURL + '</p>';
