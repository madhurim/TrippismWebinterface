(function () {
    ...
    function BaseFactory($http, $filter, $q, LocalStorageFactory, dataConstant, urlConstant, UtilFactory, tmhDynamicLocale, $locale) {
        ...
        var service = {
            ...
            getDestinationLikes: getDestinationLikes,
            deleteDestinationsLikes: deleteDestinationsLikes
        }
        return service;
        ...
        function deleteDestinationsLikes(data) {
            var url = urlConstant.apiURLforProfileActivity + "/deleteDestinationLikes";
            return $http({
                method: 'POST',
                url: url,
                data: serialize(data),
